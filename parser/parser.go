...
// check nextToken ,if matches ,then consume
...
func (p *Parser) parseExpression(precdence int) ast.Expression {
	...
	leftExpr := prefix()
	//  if the left-binding power of the next operator/token is higher than our current right-binding power.
...
func (p *Parser) parseCallExpression(function ast.Expression) ast.Expression {
	// @function function literal or function identifier
